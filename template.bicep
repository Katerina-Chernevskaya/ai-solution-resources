...
param aiHubFriendlyName string = 'AI Hub - Pilot'

@description('Friendly name for your Azure AI Project resource')
param aiProjectFriendlyName string = 'AI Hub Project - Pilot'

@description('Description of your Azure AI resource displayed in AI studio')
param aiHubDescription string = 'Azure AI Studio for the Pilot project.'

@description('Azure region used for the deployment of all resources.')
param location string = resourceGroup().location

@description('Set of tags to apply to all resources.')
param tags object = {env: 'awarait-copilot-pov'}
